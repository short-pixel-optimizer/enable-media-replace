...
<div class="wrap">
	...
	<?php if ( apply_filters( 'emr_display_replace_type_options', true ) ) : ?>
		...
		<label for="replace_type_2"><input <?= $s3pluginExist ? 'CHECKED' : '' ?> id="replace_type_2" type="radio" name="replace_type" value="replace_and_search"> <?php echo esc_html__("Replace the file, use new file name and update all links", "enable-media-replace"); ?></label>
